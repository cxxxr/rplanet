...
(deftest move-task
  (with
    (rplanet/usecases:add-column "TODO")
    (let* ((task3 (rplanet/usecases:add-task :column-name "TODO" :title "3"))
           (task2 (rplanet/usecases:add-task :column-name "TODO" :title "2"))
           (task1 (rplanet/usecases:add-task :column-name "TODO" :title "1")))
      (ok (equal (list task1 task2 task3)
                 (rplanet/usecases:get-tasks :column-name "TODO")))
      (ok (equal (list task2 task3 task1)
                 (rplanet/usecases:move-task :from (rplanet/entities:task-id task1)
                                             :to (rplanet/entities:task-id task3))))
      (ok (equal (list task2 task1 task3)
                 (rplanet/usecases:move-task :from (rplanet/entities:task-id task3)
                                             :to (rplanet/entities:task-id task1))))
      (ok (equal (list task1 task2 task3)
                 (rplanet/usecases:move-task :from (rplanet/entities:task-id task1)
                                             :to (rplanet/entities:task-id task2))))
      (ok (equal (list task1 task3 task2)
                 (rplanet/usecases:move-task :from (rplanet/entities:task-id task2)
                                             :to (rplanet/entities:task-id task3))))
      (ok (equal (list task2 task1 task3)
                 (rplanet/usecases:move-task :from (rplanet/entities:task-id task2)
                                             :to (rplanet/entities:task-id task1))))
      (ok (equal (list task3 task2 task1)
                 (rplanet/usecases:move-task :from (rplanet/entities:task-id task3)
                                             :to (rplanet/entities:task-id task2)))))))
